...
import com.yinjin.expandtextview.avcode.play.Application;
import com.yinjin.expandtextview.avcode.play.util.NetUtil;
...
public class HttpMethod {
    ...
    public static OkHttpClient genericClient() {
        ...
        //设置缓存路径
        File httpCacheDirectory = new File(Application.getInstance().getExternalCacheDir().getAbsolutePath(), "responses");
        //设置缓存 10M
        ...
        OkHttpClient httpClient = new OkHttpClient.Builder()
                .addInterceptor(new Interceptor() {
                    ...
                    public Response intercept(Chain chain) throws IOException {
                        ...
                        if (!NetUtil.getNetworkIsConnected(Application.getInstance())) {
